...
Route::group(['prefix' => 'v1', 'as' => 'api.', 'namespace' => 'Api\V1\Admin', 'middleware' => ['auth:api']], function () {
    ...
    // Jadwal Sales
    Route::post('jadwal-sales/media', 'JadwalSalesApiController@storeMedia')->name('jadwal-sales.storeMedia');
    Route::apiResource('jadwal-sales', 'JadwalSalesApiController');

    // Wars
    Route::apiResource('wars', 'WarApiController');
});
