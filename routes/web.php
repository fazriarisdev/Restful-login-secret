...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // Jadwal Sales
    Route::delete('jadwal-sales/destroy', 'JadwalSalesController@massDestroy')->name('jadwal-sales.massDestroy');
    Route::post('jadwal-sales/media', 'JadwalSalesController@storeMedia')->name('jadwal-sales.storeMedia');
    Route::post('jadwal-sales/ckmedia', 'JadwalSalesController@storeCKEditorImages')->name('jadwal-sales.storeCKEditorImages');
    Route::resource('jadwal-sales', 'JadwalSalesController');

    // Wars
    Route::delete('wars/destroy', 'WarController@massDestroy')->name('wars.massDestroy');
