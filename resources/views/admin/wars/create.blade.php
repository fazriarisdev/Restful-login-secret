...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.war.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.wars.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('sales') ? 'is-invalid' : '' }}" name="sales" id="sales">
                    ...
                    @foreach(App\Models\War::SALES_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('sales', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('sales'))
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('project_segment') ? 'is-invalid' : '' }}" name="project_segment" id="project_segment">
                    ...
                    @foreach(App\Models\War::PROJECT_SEGMENT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('project_segment', 'Government') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('model') ? 'is-invalid' : '' }}" name="model" id="model">{{ old('model') }}</textarea>
                @if($errors->has('model'))
                    <div class="invalid-feedback">
                        {{ $errors->first('model') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_project') ? 'is-invalid' : '' }}" type="number" name="value_project" id="value_project" value="{{ old('value_project', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('timeline') ? 'is-invalid' : '' }}" type="text" name="timeline" id="timeline" value="{{ old('timeline') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_name_partner') ? 'is-invalid' : '' }}" type="text" name="company_name_partner" id="company_name_partner" value="{{ old('company_name_partner', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pic_name') ? 'is-invalid' : '' }}" type="text" name="pic_name" id="pic_name" value="{{ old('pic_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('update') ? 'is-invalid' : '' }}" type="text" name="update" id="update" value="{{ old('update', '') }}">
