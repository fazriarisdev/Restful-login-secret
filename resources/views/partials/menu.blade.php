    ...
    <ul class="c-sidebar-nav">
        ...
        @can('sale_access')
            <li class="c-sidebar-nav-dropdown">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    @can('jadwal_sale_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.jadwal-sales.index") }}" class="c-sidebar-nav-link {{ request()->is('admin/jadwal-sales') || request()->is('admin/jadwal-sales/*') ? 'active' : '' }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.jadwalSale.title') }}
                            </a>
                        </li>
                    @endcan
                    @can('war_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.wars.index") }}" class="c-sidebar-nav-link {{ request()->is('admin/wars') || request()->is('admin/wars/*') ? 'active' : '' }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.war.title') }}
                            </a>
                        </li>
                    @endcan
                </ul>
